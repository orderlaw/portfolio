...
export default function AdminDashboard() {
  ...
  return (
    <main className="min-h-screen" style={{ background: "#080706" }}>
      {/* Top bar */}
      <header
        className="flex items-center justify-between px-8 md:px-12 h-14 border-b"
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className="text-[9px] uppercase tracking-[0.22em] px-4 py-2 rounded-full border transition-colors duration-200"
            style={{
          ...
          <button
            onClick={logout}
            className="text-[9px] uppercase tracking-[0.22em] transition-colors duration-200"
