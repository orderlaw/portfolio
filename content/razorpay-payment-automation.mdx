export const metadata = {
  ...
  "description": "How I made every payment log itself automatically — fees, net amount, and all — so the daily copy-paste ritual disappeared and the numbers were always right without anyone checking.",
  "image": "/images/work/razorpay-payment-automation/payments.jpg"
};
...
![alt text](/images/work/razorpay-payment-automation/case-study-3-screen.png)
...
![alt text](/images/work/razorpay-payment-automation/retry-logic.jpg)
...
![alt text](/images/work/razorpay-payment-automation/payment-breakdown.jpg)
...
![alt text](/images/work/razorpay-payment-automation/razorpay-payment-settlement.jpeg)
