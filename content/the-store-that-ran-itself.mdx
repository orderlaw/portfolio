export const metadata = {
  ...
  "description": "How I turned five disconnected tools into one operating system for a D2C electronics store — so orders, payments, shipping, and customer messages all handled themselves without anyone in the middle.",
  "image": "/images/work/the-store-that-ran-itself/google-datacenter.jpg"
};
...
![alt text](/images/work/the-store-that-ran-itself/master-main-flow.jpg)
...
![alt text](/images/work/the-store-that-ran-itself/grouped-all-workflows.png)
...
<ImageSlider images={["/images/work/the-store-that-ran-itself/grouped-all-workflows.png", "/images/work/the-store-that-ran-itself/grouped-all-workflows.png"]} />
